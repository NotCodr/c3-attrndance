  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16 text-foreground">
      ...
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        ...
        <p><strong className="text-foreground">Club committees.</strong> For people who run a club we keep their name, email address and, if they add one, a phone number. The contact named on an event is printed on that event's grant pack so the student union can reach them. It is never shown on public event pages.</p>
        ...
        <p><strong className="text-foreground">Address suggestions.</strong> When a committee member types an event venue or address, that text is sent to Photon, an OpenStreetMap search service run by komoot, to suggest matching places. Nothing else is sent with it.</p>
